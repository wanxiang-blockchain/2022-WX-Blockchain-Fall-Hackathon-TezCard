...
class OrganizationFactory(sp.Contract, FA2.OffchainviewTokenMetadata):
    def __init__(self, administrator):
        FA2.Fa2Nft.__init__(self, metadata=sp.big_map(l=None, tkey=sp.TString, tvalue=sp.TBytes), token_metadata = sp.big_map(l=None, tkey=sp.TString, tvalue=sp.TBytes))
        ...
        metadata_base = {
            ...
            "views": [self.list_factors, self.list_organization, self.list_my_created_organization, self.list_my_join_organization, self.pause_factor]
        }
